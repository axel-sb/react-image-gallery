...
const PREFIX_URL =
    'https://raw.githubusercontent.com/axel-sb/react-image-gallery/master/static/'
            ...
            <section className='app'>
                <ImageGallery
                    ...
                    slideOnThumbnailOver={
                        this.state.slideOnThumbnailOver
                    }
                            ...
                            <li>
                                <div className='app-interval-input-group'>
                                    ...
                                    <select
                                        ...
                                        onChange={this._handleThumbnailPositionChange.bind(
                                            this
                                        )}>
                                        <option value='bottom'>
                                            Bottom
                        ...
                        <ul className='app-checkboxes'>
                            ...
                            <li>
                                <input
                                    ...
                                    checked={
                                        this.state.useWindowKeyDown
                                    }
                                />
                                <label htmlFor='use_window_keydown'>
                                    use window keydown
                                </label>
                            </li>
                        </ul>
